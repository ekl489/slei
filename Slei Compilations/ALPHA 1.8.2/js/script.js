...
var playerLunged = false, playerUsedPotion = false, displayScreen = false, RLDEBuff = false;
var firstRound = true;
...
function Attack(){    
    ...
    switch(attackSelection){
        ...
        case 8:
            ...
            if(x == 0){
                feedback.push(AlertInfo("You deal 20 damage!"));
                playerDamage = 20;
            }
            else if(x == 1){
                feedback.push(AlertInfo("You and your enemy's health are swapped!"));
                var a = playerHealth;
                playerHealth = enemyHealth;
                enemyHealth = a;
            }
            else if(x == 2){
                feedback.push(AlertInfo("The enemy gets 20 extra damage!"));
                RLDEBuff = true;
            }
            else if(x == 3){
                feedback.push(AlertInfo("You deal 30 damage!"));
                playerDamage = 30;
            }
            else{
                feedback.push(AlertInfo("Nothing happend..."));
            }
            break;
        default:
            break;
